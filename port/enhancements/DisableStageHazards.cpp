...
// ABI — field access stays correct. The hardcoded offsets below are the LP64
// values; on ILP32 (e.g. Android armeabi-v7a) the pointer fields are 4 bytes
// and every offset shifts, so guard the pointer-affected asserts to LP64.
